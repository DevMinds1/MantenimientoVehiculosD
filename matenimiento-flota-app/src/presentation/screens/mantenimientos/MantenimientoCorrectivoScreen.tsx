  ...
  const generarOrden = async () => {
    ...
    try {
      const response = await fetch(
        "https://us-central1-global-tine-447000-u6.cloudfunctions.net/orders/api/register_corrective_order",
        {
          method: "POST",
          headers: {
  ...
  return (
    <GestureHandlerRootView style={globalStyles(top).container}>
      <View style={styles.containerTitle}>
        ...
        />
        <Text style={styles.title}>Mantenimiento Correctivo</Text>
      </View>
      <ScrollView>
        <View>
          {/* Vehículos */}
          ...
          {/* Fallas */}
          <View style={styles.section}>
            <Text style={styles.subtitle}>Marque sus fallas</Text>
            <View style={styles.tabs}>
