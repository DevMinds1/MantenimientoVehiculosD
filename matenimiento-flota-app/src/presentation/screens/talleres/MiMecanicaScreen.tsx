  ...
  const fetchMechanic = async () => {
    try {
      const response = await fetch(
        "http://192.168.1.12:5002/api/get_mechanic_repairshops"
      );
    ...
    <View style={globalStyles(top).container}>
      ...
      <View style={styles.containerButton}>
        ...
        <TouchableOpacity
          style={styles.button}
          onPress={() =>
            navigation.navigate("HomeTab", { screen: "MiConsecionarioScreen" })
          }
        >
          <View style={styles.containerButtonIcon}>
            <MaterialIcons
          ...
          <Text style={styles.buttonText}>Concesionaria</Text>
        </TouchableOpacity>
      </View>
